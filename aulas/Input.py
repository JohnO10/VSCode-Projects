...
from PySide6.QtWidgets import QApplication, QMainWindow, QMessageBox, QWidget, QVBoxLayout, QLineEdit, QLabel, QPushButton, QHBoxLayout, QDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ajuda_action.triggered.connect(self.mostrar_ajuda)
        ...
        # Assign entries to class attributes for easier access
    ...
    def mostrar_ajuda(self):
        ajuda_dialog = QDialog()
        ajuda_dialog.setWindowTitle("Ajuda")
        ajuda_layout = QVBoxLayout()
        ...
        ajuda_layout.addWidget(ajuda_label)

        btn_fechar = QPushButton("Fechar")
        btn_fechar.clicked.connect(ajuda_dialog.accept)
        ajuda_layout.addWidget(btn_fechar)

        ajuda_dialog.setLayout(ajuda_layout)
        ajuda_dialog.exec()
